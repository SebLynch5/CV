...
\definecolor{SwishLineColour}{HTML}{ed7d05}
\definecolor{MarkerColour}{HTML}{1e66f7}
...
\leftheader{%
  {\Huge\bfseries\sffamily Sebastian Lynch}
  
  \makefield{\faEnvelope[regular]}{\href{mailto:seblynch17103@gmail.com}{\texttt{seblynch17103@gmail.com}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/sebastiantlynch/}{\texttt{Seb Lynch}}}
  
  \makefield{\faMapMarker[regular]}{\texttt{Congleton \& Loughborough}}}
...
\newpage
\includegraphics[width=1cm]{whitespace.png}
\makerubric{skills}
\makerubric{misc}

\Large{\textbf{References available on request.}}
